    ...
    <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $promociones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promocion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr class="border-b border-gray-800 hover:bg-[#1a1a1a]/50">
                <td class="p-4 text-white"> <?php echo e($promocion->nombre); ?> </td>
                <td class="p-4 text-gray-300 capitalize"> <?php echo e($promocion->tipo); ?> </td>
                <td class="p-4 text-green-400 font-semibold"> <?php echo e($promocion->descuento); ?>% </td>
                <td class="p-4 text-gray-300"> <?php echo e($promocion->productos->count()); ?> </td>
                <td class="p-4 text-gray-300"> <?php echo e(\Carbon\Carbon::parse($promocion->fecha_inicio)->format('d/m/Y')); ?> </td>
                <td class="p-4 text-gray-300"> <?php echo e(\Carbon\Carbon::parse($promocion->fecha_fin)->format('d/m/Y')); ?> </td>
                <td class="p-4">
                ...
                <td class="p-4">
                    <div class="flex gap-2">
                        <a href="/promociones/<?php echo e($promocion->id); ?>" class="px-3 py-1.5 text-sm bg-[#25a5be]/10 text-[#25a5be] rounded-lg border border-[#25a5be]/30">
                            Ver
                        </a>
                        <a href="/promociones/<?php echo e($promocion->id); ?>/edit" class="px-3 py-1.5 text-sm bg-yellow-500/10 text-yellow-400 rounded-lg border border-yellow-500/30">
                            Editar
                        </a>
                        <form action="/promociones/<?php echo e($promocion->id); ?>" method="POST" class="form-eliminar flex m-0"> 
                            <?php echo csrf_field(); ?>
...
<div id="pagination-container" class="bg-[#1a1a1a] p-4 border-t border-gray-800 flex justify-between items-center text-sm text-gray-400">
    <div>
        Mostrando registros del <?php echo e($promociones->firstItem() ?? 0); ?>

        al <?php echo e($promociones->lastItem() ?? 0); ?>

        de un total de <?php echo e($promociones->total()); ?>
...
<?php /**PATH C:\Users\USUARIO\Desktop\Aplicaciones Web\Boyz in the Sneaker\aplicaciones-web-laravel\resources\views/promociones/partials/tabla.blade.php ENDPATH**/ ?>