...
<div class="max-w-2xl mx-auto">
    <div class="mb-8">
        ...
        <p class="text-gray-400 mt-1">Modifica el nombre de la clasificación seleccionada.</p>
    </div>
    ...
    <div class="bg-[#121212]/80 p-6 rounded-xl border border-gray-800 shadow-lg">
        <form action="/categorias/{{ $categoria->id }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="nombre" value="{{ $categoria->nombre }}" class="w-full bg-[#1a1a1a] border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#25a5be]" required>
            </div>
