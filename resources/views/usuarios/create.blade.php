...
<div class="max-w-2xl mx-auto">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-white">Nuevo Usuario</h1>
        <p class="text-gray-400 mt-1">Genera un acceso al sistema con permisos específicos.</p>
    </div>
    ...
    <div class="bg-[#121212]/80 p-6 rounded-xl border border-gray-800 shadow-lg">
        <form method="POST" action="/usuarios">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="username" required class="w-full bg-[#1a1a1a] border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#25a5be]">
            </div>

            <div class="mb-5">
                <label class="block text-gray-300 mb-2">Contraseña <span class="text-red-500">*</span></label>
                <input type="password" name="password" required class="w-full bg-[#1a1a1a] border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#25a5be]">
            </div>
            ...
            <div class="mb-6">
                ...
                <select name="rol" required class="w-full bg-[#1a1a1a] border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#25a5be]">
                    ...
                    <option value="gestor_productos">Gestor Productos</option>
                    <option value="gestor_stock">Gestor Stock</option>
                </select>
            </div>
